...
如果您发现了 bug 或有改进建议，请通过 [GitHub Issues](https://github.com/Tanox/GitHub_Chinese/issues) 提交。
...
- 查看 [GitHub Issues](https://github.com/Tanox/GitHub_Chinese/issues) 是否有类似问题
- 创建新的 Issue 寻求帮助
- 通过邮件联系维护者
